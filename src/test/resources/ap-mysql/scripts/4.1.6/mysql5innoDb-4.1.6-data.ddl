...
--  *********************************************************************
--  Change Log: src/main/resources/db/changelog-4.1.6-data.xml
--  Ran at: 11/25/20 11:37 AM
--  Against: null@offline:mysql?changeLogFile=/Users/cosmin/IdeaProjects/domibus/Domibus-MSH-db/target/liquibase/changelog-4.1.6-data.mysql
--  Liquibase version: 3.5.3
--  *********************************************************************

--  Changeset src/main/resources/db/changelog-4.1.6-data.xml::EDELIVERY-2144::thomas dussart
--  inserts
...
--  Changeset src/main/resources/db/changelog-4.1.6-data.xml::insert_ws_default_auth::idragusa
